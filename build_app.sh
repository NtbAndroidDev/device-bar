...
echo "🔨 [1/3] Đang biên dịch DeviceBar (Release)..."
swift build -c release

BIN_PATH="$DIR/.build/release/DeviceBar"
APP_DIR="$DIR/DeviceBar.app"
